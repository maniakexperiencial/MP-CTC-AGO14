    ...
    <div class="column" id="content_wrap">
        ...
        <div class="row">
            <div class="three wide column" id="Left_bar">
                ...
                <a href="{{ URL::route('papas_historias') }}"><img data-alt-src="{{ URL::to('/img/hovers/historias.png') }}" src="{{ URL::to('/img/historias.jpg') }}"></a>
                <a href="{{ URL::route('papas_videos') }}"><img data-alt-src="{{ URL::to('/img/hovers/video.png') }}" src="{{ URL::to('/img/video.jpg') }}"></a>
                <a href="{{ URL::route('papas_bases') }}"><img data-alt-src="{{ URL::to('/img/hovers/bases.png') }}" src="{{ URL::to('/img/bases.jpg') }}"></a>
