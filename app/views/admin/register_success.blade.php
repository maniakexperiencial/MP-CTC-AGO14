	...
	<div class="loginbox">
    	<div class="loginboxinner">
            ...
            <div class="logo">
                ...
                <div style="text-align: center;font-size: 24px;margin-top: 20%;font-weight: bold;">¡Registro Exitoso!</div>
            <p style="margin-top: 5%; text-align: center;font-size: 16px;">
                A continuación se enviará un correo para completar su registro.
            </p>
