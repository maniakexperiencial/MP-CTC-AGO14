            ...
            @foreach($cuentos as $cuento)
                        ...
                        <div class="hidden_cuento" id="cuento<?= $cuento->id ?>" >
                            ...
                            <div class="cuento_box" id="{{ $cuento->id }}">
                                ...
                                <div class="ui grid">
                                    <div class="row">
                                        <div class="eight wide column cuento_opciones"><img src="<?php public_path().'/img/likes.png' ?>">{{$cuento->likes->count()}}</div>
                                        <div class="eight wide column cuento_opciones"><img src="<?php public_path().'/img/views.png' ?>">{{$cuento->views->count()}}</div>
