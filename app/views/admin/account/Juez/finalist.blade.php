    ...
    <div id="contentwrapper" class="contentwrapper">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablequick table_blue"  >
            ...
            <tr class="gradeA">
                ...
                <td>Niños</td>
                <td><div  class="finalist_wrap_cell">9.3 </div></td>
                <td><div  class="finalist_wrap_cell">1 </div></td>
                <td class="center"><a href="" class="vote">votar</a></td>
            </tr>
            <tr class="gradeA">
                ...
                <td>Nombre del cuento</td>
                <td>Niños</td>
                <td><div  class="finalist_wrap_cell">9.1 </div></td>
                <td><div  class="finalist_wrap_cell">2</div></td>
                <td class="center"><a href="" class="vote">votar</a></td>
            </tr>
            <tr class="gradeA">
                ...
                <td>Nombre del cuento</td>
                <td>Niños</td>
                <td><div  class="finalist_wrap_cell">8.6 </div></td>
                <td><div  class="finalist_wrap_cell">3 </div></td>
                <td class="center"><a href="" class="vote">votar</a></td>
            </tr>
            <tr class="gradeA">
