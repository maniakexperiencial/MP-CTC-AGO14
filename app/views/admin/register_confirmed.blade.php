	...
	<div class="loginbox">
    	<div class="loginboxinner">
            ...
            <div class="logo">
                ...
                <div style="text-align: center;font-size: 16px;margin-top: 20%;font-weight: bold;">Se ha confirmado la direccion de correo electronico</div>
            <div style="text-align: center;font-size: 24px;margin-top: 10%;font-weight: bold;">
                @if (Session::has('mail'))
                {{ Session::get('mail') }}
                @endif
            </div>
            ...
            <p style="margin-top: 5%; text-align: center;font-size: 16px;">
               Puede utilizar esta dirección de correo electronico para ingresar a nuestro sitio.
            </p>
